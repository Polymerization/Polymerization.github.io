(() => {
  ...
  var render = function(ctx) {
    return function(model) {
      ...
      return function __do6() {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 259, column 3 - line 273, column 85): " + [model.constructor.name]);
      };
    };
  };
  ...
  var update = function(v) {
    return function(v1) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 90, column 1 - line 90, column 35): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var main = function __do5() {
    ...
    var allSigs = append1(updateTickSig)(append1(jumpSig)(tapJumpSig));
